...
function get_x_931(text) {
    ...
    var o = '101_3_3.0'
    , i = '"AIBRdNC9BhWPToawSHkd7XMYmoEcCgzF4t0=|1654009664"'
    , a = null
    , u = z(text)
    , c = G(undefined)
    , s = [o, u, i, V(c) && c, a].filter(Boolean).join("+");
    console.log(zhao(s))
    console.log(get_D(zhao(s)))
    return {
        source: s,
        signature: "2.0_" + get_D(zhao(s))
    }
}
console.log(get_x_931("/api/v3/feed/topstory/recommend?action=down&ad_interval=3&after_id=17&desktop=true&page_number=4&session_token=0d021fd9d16f5e6409526dd0263b79a5"))